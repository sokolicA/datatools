...
Columns <- R6::R6Class(
    ...
    public = list(
        ...
        drop = function(columns) {
            ...
            if (any(columns %in% private$find_group_cols(private$df_env$grp_expr))) stop("Can not drop columns used in grouping!")
        ...
        rename = function(mapping) {
            ...
            private$df_env$grp_expr <- private$rename_grouping(private$df_env$grp_expr, names(mapping), mapping)
        ...
        rename_with = function(mapper) {
            ...
            private$df_env$grp_expr <- private$rename_grouping(private$df_env$grp_expr, self$names, mapper(self$names))
